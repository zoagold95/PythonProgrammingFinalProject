        ...
        try:
            ...
            for i in range(20):
                ...
                if response.status_code == 200:
                    ...
                    """Altered code. Instead of just printing captcha error, read from csv."""
                    if not NAME:
                        print('Reached limit of Amazon requests from this IP. Prices may not be up to date.')
                        pass
